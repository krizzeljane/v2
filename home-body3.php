...
<section class="home-section three home">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="">
					<img src="images/demo-04.png"  style="height:280px; margin: 0 auto;"  alt="CARWAVE - Your Trusted Car Dealership Network" class="img-responsive" >
					<div class="caption">
			...
			<div class="col-md-6">
				<div class="">
					<img src="images/inspector-07.png"   style="height:280px; margin: 0 auto;" alt="CARWAVE - Your Trusted Car Dealership Network"   class="img-responsive" >
					<div class="caption">
...
<section class="home-section home demo">
	<div class="container">
		<div class="section-content">
			<div class="row">
				<div class="col-md-6">
					<!-- <img src="images/demo-04.png" class="img-responsive"> -->
				</div>
				<div class="col-md-6">
					<div class="text-center">
