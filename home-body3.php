...
<div id="background-carousel">
	<div id="myCarousel" class="carousel carousel-fade" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="item slide-2" style="background-image:url(images/slider-12.jpg)">
				<div class="container">
					<h1 class="slider-texts slider-text-1">
			...
			<div class="item slide-3" style="background-image:url(images/slider-13.jpg)">
				<div class="container">
					<h1 class="slider-texts slider-text-1">
...
<section class="home-section three home">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="">
		      <img src="images/auction-view.png" alt="..." class="img-responsive" >
		      <div class="caption">
			...
			<div class="col-md-6">
				<div class="">
		      <img src="images/inspector.jpg" alt="..."  class="img-responsive" >
		      <div class="caption">
...
<section class="home-section dark-p home">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div>	
					<div class="row">
						...
						<div class="col-sm-5">
							<div class="cw-img">
								<img src="images/states-02.png"  class="pull-right img-responsive">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="home-img-cont">
					<img class="img-responsive" src="https://media.istockphoto.com/photos/people-shaking-hands-in-car-showroom-picture-id905468040?s=2048x2048">
				</div>
			</div>
			<div class="col-md-6">
				<div style="">
...
<section class="home-section bg-primary-one home">
	<div class="container">
