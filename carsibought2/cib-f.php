<div class="trans-con cib-f trans-f card">
	<div class="row">
							...
							<div class="col-lg-9">
								...
								<div class="row v-row-col">
									...
									<div class="col-lg-4 padding-left-lg padding-right-lg visible-lg">
										<ul class="list-unstyled v-row-list">
											<li>
												<p class="card-title loading">
												<!-- <div class="row">
													<div class="col-xs-5 padding-right-xs">
														<p>Transport:</p>
													</div>
													<div class="col-xs-7 text-right padding-left-xs">
														<a href="javascript:;" class="vrow-edit btn-link-default" data-toggle="popover" data-placement="bottom" data-content="To change your transport method, please call 844-428-9638"><i class="fa fa-pencil-alt"></i> Arrange my own</a> </p>
													</div>
												</div> -->
											</li>
											<li>
								...
								<div class="row v-row-col">
									...
									<div class="col-lg-4 padding-left-lg padding-right-lg visible-lg">
										<ul class="list-unstyled v-row-list">
											...
											<li>
												<button class="btn btn-default btn-block" type="button" data-toggle="modal" data-target="#invoice-franchise-buyer">
													Invoice
												</button>
											</li>
										</ul>
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="v-row-stat success-stat">
											...
											<p class="stat-text">
												PURCHASED <br class="visible-lg">(BUY NOW)
											</p>
											<p class="stat-amount">$11,000</p>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-12 col-xs-6">
										<div class="dropdown element">
											...
											<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
												<li><a href="javascript:;">Request Adjustment</a></li>
												<li><a href="javascript:;">Cancel Arbitration</a></li>
												<li class="divider"></li>
												<li><a href="javascript:;">Send Message</a></li>
											</ul>
										</div>
