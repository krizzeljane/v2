<div class="modal fade" id="invoice-franchise-buyer-norwalk" tabindex="-1" role="dialog" aria-labelledby="invoice-buyer">
        ...
        <div class="invoice invoice-modal">
          ...
          <div class="panel panel-danger">
            <div class="panel-heading">
              <p class=""><i class="fa fa-exclamation-circle"></i> <strong>Important Instructions:</strong>  Please send payment within <strong>2 business days after receiving vehicle.</strong> <br><br>Make check payable to: <br><strong>Norwalk Auto Auction <br>
                  12405 Rosecrans Ave, Norwalk, CA 90650<br>
                  Phone: (562) 864-7464 <br>
                Fax: (562) 863-2776</strong></p>
            </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6 no-padding-right">
                        <div class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label class="col-xs-6 control-label">Facilitating Location:</label>
                            <div class="col-xs-6">
                              <p class="form-control-static">Norwalk Auto Auction <br>12405 Rosecrans Ave, Norwalk, CA 90650<br>
                                Phone: (562) 864-7464 <br>
                              Fax: (562) 863-2776
                              </p>
                            </div>
