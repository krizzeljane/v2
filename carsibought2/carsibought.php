...
include('transport-modal.php');
include('cib-edit.php');
?>
  ...
  <div class="container">
    ...
    <div class="tab-content">
      <div role="tabpanel" class="tab-pane fade in active" id="cib-f">
        ...
        <div class="page-actions visible-sm visible-xs">
          <div class="row">

            <div class="col-sm-12">
              <div class="search element" style="width: 82%; margin-right: 5px;">
                <div class="form-group has-feedback">
                  <label class="control-label sr-only" for="inputSuccess5">Hidden label</label>
                  <input type="text" class="form-control" id="inputSuccess5" aria-describedby="inputSuccess5Status" placeholder="Search VIN, Make, Model">
                  <span class="glyphicon glyphicon-search form-control-feedback" aria-hidden="true"></span>
