      ...
      <div class="row">
        <div class="col-md-8">
          <div class="form-group has-error has-feedback">
            ...
            <input type="text" class="form-control" disabled="disabled" id="firstname" placeholder="Enter Dealership Name">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" disabled="disabled" class="form-control" id="nickname" placeholder="Enter Dealership LIC Number">
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="form-group">
            ...
            <input type="text" class="form-control" disabled="disabled" id="email" placeholder="Doing Business As">
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <div class="checkbox disabled">
              <input type="checkbox" disabled="disabled" checked="" name="group2" id="checkbox-1">
  ...
  <div class="row">
    ...
    <!-- <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="text" disabled="disabled" class="form-control text-right" id="aan" placeholder="$0">
      </div>
    </div> -->
