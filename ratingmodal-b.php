<div class="">
	<div class="dm-vi">
		<div class="row">
			...
			<div class="col-xs-1">
				<a href="javascript:;" class="pull-right btn-link-default hidden-lg hidden-md" type="button" onclick="$('.dm-vi-p').toggleClass('hidden-xs hidden-sm');">
	...
	<div class="row">
		<div class="col-lg-12 text-center">
			<div class="thumb thumb-md text-center" style="margin: 20px auto 5px;">
				<img src="images/ryan.png">
			</div>
		 <h4 style="margin: 0px;">Ryan Farina</h4>
	...
	<p class="text-center text-danger"> Please fill out all rating criteria.</p>

	<div class="modal-body">
		<textarea class="form-control" placeholder="Leave a Comment"></textarea>
		<!-- <div class="checkbox">
				<input type="checkbox" name="group2" id="checkbox-2">
				<label for="checkbox-2"><span class="check">Leave comment anonymously</span></label>
			</div> -->
	</div>
