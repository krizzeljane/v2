<div class="modal fade" id="invoice-franchise-seller-tdf" tabindex="-1" role="dialog" aria-labelledby="invoice-buyer">
                        ...
                        <div class="form-horizontal">
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-xs-6">
                              <p class="form-control-static">CARWAVE Guarantee <!-- <br>
                          ...
                          <div class="form-group">
                            <label class="col-xs-6 control-label">Facilitation Location:</label>
                            <div class="col-xs-6">
                      ...
                      <div class="col-sm-6 col-print-6">
                        <div class="form-horizontal">
                          ...
                          <div class="form-group total">
                            ...
                            <div class="col-xs-6">
                              <p class="form-control-static text-right text-success">$23,875</p>
                            </div>
                          </div><!-- form-group -->
                        </div><!-- form-horizontal -->

                        <p class="text-light"><small><em>Both parties agree to abide by <a href="#">"CARWAVE Guidelines Terms and Conditions."</a></em></small></p>
