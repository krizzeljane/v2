<div id="printThis">
  <div class="modal fade" id="invoice-franchise-seller-unwound" tabindex="-1" role="dialog" aria-labelledby="invoice-buyer">
        ...
        <div class="invoice invoice-modal">
          ...
          <div class="panel panel-danger">
            <div class="panel-heading">
              <p class=""><i class="fa fa-exclamation-circle"></i> <strong>Important Instructions: </strong> Please send copies of properly executed title docs <strong>within 24 hours to the buyer</strong>.</p>
            </div>
          </div>
