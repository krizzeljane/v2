<div class="modal fade" id="invoice-ti-seller" tabindex="-1" role="dialog" aria-labelledby="invoice-buyer">
                  ...
                  <div class="inv-v-trans">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-horizontal">
                          <div class="form-group">
                            <label class="col-xs-8 control-label">Sale Price:</label>
                            <div class="col-xs-4">
                              <p class="form-control-static text-right">$3,100</p>
                            </div>
                          </div><!-- form-group -->
                          <div class="form-group">
                            <label class="col-xs-8 control-label">Sale Fee:</label>
                            <div class="col-xs-4">
                              <p class="form-control-static text-right">($0)</p>
                            </div>
                          </div><!-- form-group -->
                          <div class="form-group">
                            <label class="col-xs-8 control-label">Inspection Fee:</label>
                            <div class="col-xs-4">
                              <p class="form-control-static text-right">($0)</p>
                            </div>
                          </div><!-- form-group -->
