...
<body class="bg-white no-margin">
	...
	<section class="cw hwd-banner">
			...
			<div class="row">
				<div class="col-md-5">
					<div class="">
						...
						<br>
						<p style="font-size: 18px; line-height: 1.6;  color: #666; font-weight: 300;">
							As we grow, we are working hard every day to improve  your customer experience.  CARWAVE takes pride in our transparency and honesty, and we welcome all of your feedback.  Let us know what we are doing right and where we can improve.  Feel free to <a href="http://cts.vresp.com/c/?Carwave/96a3559b93/f03a10a56e/1762424d73" target="_blank"><strong>give us a Google review</strong></a>, send us an email or give us a call at 844-428-9638. 
							<br><br>
							Thanks for giving us the opportunity to serve you!
							<br>
							<strong>– CARWAVE Team</strong></p>
							<br>
							<div class="text-left">
								<a href="#gr-revs" class="btn btn-lg btn-default">View our Google Reviews</a>
							</div>
						</div>
					</div>
					<div class="col-md-7">
						<br>
						<div class="row gr-form"><br>
			...
			<div class="container whycw">
				<div class="row">
					<div class="col-md-12">
						<div class="gr-revs">
							<script src="https://apps.elfsight.com/p/platform.js" defer></script>
							<div class="elfsight-app-65cec73c-4c1c-4488-9341-16d178a22591"></div>
						</div>
					</div>
				</div>
		...
		<section class="cw whycw">
			<div class="container">
			</div>
		</section>

		<section class="cw bg-white whycw">
			<div class="container-fluid">

				<div class="row cw-row">
					<div class="col-md-6 bg-primary-one">
						<div class="cw-cont">
							<div class="cw-text text-center">
								<br><br>
		...
		<section class="bg-lightest">
			<div class="container hwd-socials">
				<p class="fb"> <a href="https://www.facebook.com/carwaveauctions" target="_blank"> <i class="fab fa-facebook-square"></i></a></p>
