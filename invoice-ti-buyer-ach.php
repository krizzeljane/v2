...
<html>
<head>
  <title>Trade-in Cash Invoice</title>
  ...
  <div class="invoice invoice-modal">
    ...
    <div class="panel panel-danger">
      <div class="panel-heading">
        <h5><i class="fa fa-exclamation-circle"></i> <strong>Important Instructions</strong></h5>
      </div>
      <div class="panel-body">
        <p>Please deposit cash by 5PM the next day to: <br><br>
          <strong>
            Bank of America<br>
            CARWAVE<br>
                ...
                <div class="row">
                  <div class="col-sm-6 no-padding-right">
                    <div class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <p class="form-control-static">ACH</p>
                        </div>
                      </div><!-- form-group -->
                  ...
                  <div class="col-sm-5">
                    <div class="form-horizontal">
                      ...
                      <div class="form-group">
                        <label class="col-sm-6 control-label">Buy Fee:</label>
                        <div class="col-sm-4">
                          <p class="form-control-static text-right">$235</p>
                        </div>
                      </div><!-- form-group -->
                      <div class="form-group">
                        <label class="col-sm-6 control-label">"As Described" Guarantee:</label>
                        <div class="col-sm-4">
