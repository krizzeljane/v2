<div class="modal fade" id="invoice-franchise-buyer-tdf" tabindex="-1" role="dialog" aria-labelledby="invoice-buyer">
                      ...
                      <div class="col-sm-6 no-padding-right">
                        <div class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-6">
                              <p class="form-control-static">TDF Guarantee <br>
                                <small></small>
                              </p>
                            </div>
                          </div><!-- form-group -->
                      ...
                      <div class="col-sm-6">
                        <div class="form-horizontal">
                          ...
                          <div class="form-group total">
                            ...
                            <div class="col-xs-6">
                              <p class="form-control-static text-right">$25,125</p>
                            </div>
                          </div><!-- form-group -->
