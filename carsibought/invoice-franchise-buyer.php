<div class="modal fade" id="invoice-franchise-buyer" tabindex="-1" role="dialog" aria-labelledby="invoice-buyer">
        ...
        <div class="invoice invoice-modal">
          ...
          <div class="panel panel-danger">
            <div class="panel-heading">
              <p class=""><i class="fa fa-exclamation-circle"></i> <strong>Important Instructions:</strong>  Please pay seller within <strong>24 hours upon receiving copies of properly executed title docs.</strong></p>
            </div>
          </div>
                  ...
                  <div class="inv-v-trans">
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-print-6 no-padding-right">
                        <div class="form-horizontal">
                          <div class="form-group">
                            <label class="col-xs-6 control-label">Purchase Date:</label>
                            <div class="col-xs-6">
                      ...
                      <div class="col-sm-6 col-print-6">
                        <div class="form-horizontal">
                          <div class="form-group">
                            <label class="col-xs-6 control-label">Purchase Price:</label>
                            <div class="col-xs-6">
                          ...
                          <div class="form-group">
                            <label class="col-xs-6 control-label">Adjustment:</label>
                            <div class="col-xs-6">
